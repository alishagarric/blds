...
const AboutPage: NextPage<AboutPage> = () => {
  return (
    <>
      <Navigation homepage={true} key={AboutPageClassName} />
            ...
            textBlocks={[
              {
                _type: "text",
                text: {
                  __html: `<p class="p-lg">For nearly 45 years the nationally recognized statistics and economics experts of BLDS have advised law firms and their clients – including Fortune 500 corporations, government agencies, and privately held businesses – on a wide variety of issues that require quantitative expertise and explanation.</p>`,
                },
              },
              {
                _type: "text",
